...
export default function ProductsPage() {
    ...
    const fetchProducts = async () => {
        setLoading(true)
        try {
            const res = await fetch('/api/products/analytics?period=all')
    ...
    return (
        <div className="p-8 space-y-8">
            ...
            {/* Add/Edit Form */}
            {showForm && (
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border dark:border-gray-700 animate-in fade-in slide-in-from-top-4">
